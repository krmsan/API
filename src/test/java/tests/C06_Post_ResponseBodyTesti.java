...
public class C06_Post_ResponseBodyTesti {
    ...
    public void post02(){
        ...
        reqBody2.put( "title","API");
        reqBody2.put( "body","API ogrenmek ne guzel");
        reqBody2.put( "userId",10);
        reqBody2.put( "tumbody",reqBody.toString());
        ...
        response.
                ...
                body("tumbody",Matchers.equalTo(reqBody.toString()));
